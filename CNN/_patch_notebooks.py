"""One-off patcher for CNN sandbox notebooks. Run from repo: python CNN/_patch_notebooks.py"""
import json
import re
...
def patch_conv1d():
    ...
    i_df, _ = find_cell(lambda t: "read_csv" in t and "BTCUSDT" in t)
    i_split, _ = find_cell(lambda t: "train_end_idx = int(len(df)" in t)
