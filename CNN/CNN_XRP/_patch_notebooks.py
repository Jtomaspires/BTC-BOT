"""One-off patcher for CNN_XRP sandbox notebooks. Run from repo: python CNN_XRP/_patch_notebooks.py"""
import json
import re
...
def patch_conv1d():
    ...
    i_df, _ = find_cell(lambda t: "read_csv" in t and ("DATA_CSV" in t or "BTCUSDT" in t or "XRPUSDT" in t))
