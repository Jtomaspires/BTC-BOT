...
| Task | Action |
|------|--------|
| Stop | `sudo systemctl stop binance-bot` |
| Restart after `.env` change | `sudo systemctl restart binance-bot` |
| View logs | `journalctl -u binance-bot -f` and/or `tail -f trading_bot/log.log` |
